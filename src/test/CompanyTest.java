...
class CompanyTest {
	...
	public void setUp2() {
		try {
			...
			c.addRegisteredUser(87878, "Andrea", "Nu�ez", "78787", "Kra 9", DocumentType.CITIZENSHIP_CARD, "1010138801");
	...
	void addRegisteredUserTest() {
		...
		assertThrows(UserAlreadyExistsException.class, () -> c.addRegisteredUser(87878, "Andrea", "Nu�ez", "78787",
	...
	void addTurnTest() {
		try {
			// Genera un nuevo turno= i. Consecutivo al �ltimo turno asignado
			setUp3();
			...
			// iii. Si el �ltimo turno generado es el D99 entonces genera el turno E00
			setUp4();
